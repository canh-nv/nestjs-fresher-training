...
# Docker Usage Guide for NestJS Project

Below are the steps to build the Docker image, run the application in a container, and verify if the application is working properly by calling an API.
